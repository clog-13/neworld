...
## [为类型实现特征](https://course.rs/basic/trait/trait.html#为类型实现特征)
...
#### [特征定义与实现的位置(孤儿规则)](https://course.rs/basic/trait/trait.html#特征定义与实现的位置孤儿规则)
...
#### [默认实现](https://course.rs/basic/trait/trait.html#默认实现)
...
## [特征约束(trait bound)](https://course.rs/basic/trait/trait.html#特征约束trait-bound)
...
#### [多重约束](https://course.rs/basic/trait/trait.html#多重约束)
...
#### [使用特征约束有条件地实现方法或特征](https://course.rs/basic/trait/trait.html#使用特征约束有条件地实现方法或特征)
...
## [函数返回中的 `impl Trait`](https://course.rs/basic/trait/trait.html#函数返回中的-impl-trait)
...
## [修复上一节中的 `largest` 函数](https://course.rs/basic/trait/trait.html#修复上一节中的-largest-函数)
...
## [通过 `derive` 派生特征](https://course.rs/basic/trait/trait.html#通过-derive-派生特征)
...
## [几个综合例子](https://course.rs/basic/trait/trait.html#几个综合例子)

#### [为自定义类型实现 `+` 操作](https://course.rs/basic/trait/trait.html#为自定义类型实现--操作)
...
#### [自定义类型的打印输出](https://course.rs/basic/trait/trait.html#自定义类型的打印输出)
